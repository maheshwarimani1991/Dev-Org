...
[SELECT j.Unit_Price__c,j.Merchandise__r.Price__c FROM Line_Item__c j WHERE j.Invoice_Statement__r.Status__c='negotiating' AND j.Merchandise__r.id IN :TRIGGER.new FOR UPDATE
];
